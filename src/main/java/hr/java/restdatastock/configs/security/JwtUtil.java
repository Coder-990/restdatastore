...
//        try {
//            return getJwtClaimsSetToString(getJwtClaimsSetAccesToken(username, issuer, roles));
//        }
...
//        try {
//            return getJwtClaimsSetToString(getJwtClaimsSetRefreshToken(username));
//        }
//        catch (JOSEException e) {
//            throw new RuntimeException("Error to create JWT", e);
//        }
//    }
//
//    private static JWTClaimsSet getJwtClaimsSetAccesToken(String username, String issuer, List<String> roles) {
...
//    }
//
//    private static JWTClaimsSet getJwtClaimsSetRefreshToken(String username) {
//        return new JWTClaimsSet.Builder()
//                .subject(username)
...
//    }
//
//    private static String getJwtClaimsSetToString(JWTClaimsSet claims) throws JOSEException {
